...
CREATE TABLE `pacientes` (
  ...
  `obra_social` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `historial_medico` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
