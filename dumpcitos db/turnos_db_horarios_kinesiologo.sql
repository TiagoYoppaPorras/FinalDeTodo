...
CREATE TABLE `horarios_kinesiologo` (
  ...
  `dia_semana` enum('Lunes','Martes','Miércoles','Jueves','Viernes','Sábado') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hora_inicio` time NOT NULL,
  `hora_fin` time NOT NULL,
  PRIMARY KEY (`id`),
  KEY `kinesiologo_id` (`kinesiologo_id`),
  CONSTRAINT `horarios_kinesiologo_ibfk_1` FOREIGN KEY (`kinesiologo_id`) REFERENCES `kinesiologos` (`id`) ON DELETE CASCADE
